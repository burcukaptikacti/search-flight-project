...
public class FlightControllerIntegrationTest {
	...
	public void testfindFlight() throws Exception {
		...
		FlightRequest dto = new FlightRequest("SAW", "AMS", LocalDate.of(2020, 03, 01), LocalDate.of(2020, 03, 04), 3);
		...
		mvc.perform(
				get("/flights?departureDate=2020-03-01&destination=AMS&origin=SAW&passengerCount=3&returnDate=2020-03-04")
